...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-100 pt-12 pb-6" suppressHydrationWarning>
      <div className="container mx-auto px-4" suppressHydrationWarning>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">
              Cung cấp thực phẩm tươi ngon, chất lượng cao với giá tốt nhất cho
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="mailto:contact@freshmart.vn"
        ...
        <div className="border-t border-gray-300 pt-6">
          ...
          <p className="text-center text-xs text-gray-500 mt-2">
            GPKD số 0123456789 do Sở KHĐT TP.HCM cấp ngày 01/01/2025
          </p>
        </div>
      </div>
    </footer>
